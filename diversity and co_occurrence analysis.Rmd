...
mlst.div<-mlst.div[order(mlst.div[,1]),]
mlst.div
```

Diversity by GPSC
```{r}
gps.sdi<-diversity.func(gps1.c)
gps.div<-t(sapply(sugs, diversity.cor.func, ds=gps.sdi))
gps.div<-gps.div[order(gps.div[,1]),]
gps.div
